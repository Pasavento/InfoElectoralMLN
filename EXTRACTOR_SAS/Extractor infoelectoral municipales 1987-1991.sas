...
data Candidaturas_global;
	infile '/folders/myfolders/sasuser.v94/1987 Municipales/03048706.csv' ENCODING='wlatin1';
...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/1987 Municipales/09048706.csv' ENCODING='wlatin1';
...
data Resultados_MLN;
	infile '/folders/myfolders/sasuser.v94/1987 Municipales/10048706.csv' ENCODING='wlatin1';
	input Tipo 1-2 Year 3-6 Mes 7-8 Vuelta 9 CCAA 10-11 Prov 12-13 Mun 14-16 
...
PROC EXPORT DATA=Todo_MLN_Secciones DBMS=XLS LABEL 
		...
		SHEET='11987 Locales'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
