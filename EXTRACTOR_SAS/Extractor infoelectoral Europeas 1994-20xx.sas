...
data Candidaturas_global;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/2014 Europeas/03071405.DAT' ENCODING='wlatin1';
...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/2014 Europeas/09071405.DAT' ENCODING='wlatin1';
...
data Resultados_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/2014 Europeas/10071405.DAT' ENCODING='wlatin1';
	input Tipo 1-2 Year 3-6 Mes 7-8 Vuelta 9 CCAA 10-11 Prov 12-13 Mun 14-16 
...
PROC EXPORT DATA=Todo_MLN_Secciones DBMS=XLS LABEL 
		...
		SHEET='12014 Europeas'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
