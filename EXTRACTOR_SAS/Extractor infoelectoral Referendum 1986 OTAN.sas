...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/_REFERENDUM/1986 Referendum/09018603.DAT' ENCODING='wlatin1';
	input Prov 12-13 Distr $ 18 Secc $ 21-22 Mesa $ 23 INE 24-30 CERA 31-37 CERE 38-44 CEREV 45-51 
...
PROC EXPORT DATA=Todo_MLN_Secciones DBMS=XLS LABEL 
		...
		SHEET='11986 Ref. OTAN'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
