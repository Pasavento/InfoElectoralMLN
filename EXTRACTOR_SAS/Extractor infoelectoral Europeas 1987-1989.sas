...
data Candidaturas_global;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1989 Europeas/03078906.DAT' ENCODING='wlatin1';
...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1989 Europeas/09078906.DAT' ENCODING='wlatin1';
...
data Resultados_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1989 Europeas/10078906.DAT' ENCODING='wlatin1';
	input Tipo 1-2 Year 3-6 Mes 7-8 Vuelta 9 CCAA 10-11 Prov 12-13 Mun 14-16 
		Distr $ 18 Secc $ 21-22 Mesa $ 23 Partido 24-29 Votos 30-36;
	ID=Distr||'-'||Secc;
...
PROC EXPORT DATA=Todo_MLN_Secciones DBMS=XLS LABEL 
		...
		SHEET='11989 Europeas'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
