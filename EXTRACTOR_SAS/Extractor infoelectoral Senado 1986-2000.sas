...
data Candidaturas_global;
	infile '/folders/myfolders/sasuser.v94/_SENADO/2000 Senado/03030003.DAT' ENCODING='wlatin1';
...
data Candidatos_global;
	infile '/folders/myfolders/sasuser.v94/_SENADO/2000 Senado/04030003.DAT' ENCODING='wlatin1';
...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/_SENADO/2000 Senado/09030003.DAT' ENCODING='wlatin1';
...
data Resultados_MLN;
	infile '/folders/myfolders/sasuser.v94/_SENADO/2000 Senado/10030003.DAT' ENCODING='wlatin1';
	input Tipo 1-2 Year 3-6 Mes 7-8 Vuelta 9 CCAA 10-11 Prov 12-13 Mun 14-16 
...
data Candidatos_MLN_Siglas;
	...
	BY Partido;
	Senador_siglas=TRIM(Nombre_Senador)||' ('||TRIM(Siglas)||')';
	IF a=1 and b=1 then
		output;
run;
...
data Resultados_secciones_senador;
	...
	DROP Year Mes Vuelta Prov Codigo_prov Codigo_CCAA Codigo_nac Distr_elect Partido Orden Titular Sexo Dia_birth Mes_birth Year_birth DNI Electo;
	BY Partido_senador;
...
PROC EXPORT DATA=Todo_MLN_Secc_Senador DBMS=XLS LABEL 
		...
		SHEET='12000 Senadores'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;

PROC EXPORT DATA=Todo_MLN_Secc_Partidos DBMS=XLS LABEL 
		OUTFILE='/folders/myfolders/sasuser.v94/ELECIONNES_MLN_FINAL_SECCIONES' REPLACE;
		SHEET='12000 Senado'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
