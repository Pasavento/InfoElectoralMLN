...
data Candidaturas_global;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1999 Europeas/03079906.DAT' ENCODING='wlatin1';
...
data Participacion_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1999 Europeas/09079906.DAT' ENCODING='wlatin1';
...
data Resultados_MLN;
	infile '/folders/myfolders/sasuser.v94/_EUROPEAS/1999 Europeas/10079906.DAT' ENCODING='wlatin1';
	input Tipo 1-2 Year 3-6 Mes 7-8 Vuelta 9 CCAA 10-11 Prov 12-13 Mun 14-16 
...
data Todo_MLN_Partidos;
	MERGE Resultados_MLN_Siglas_transp Participacion_MLN;
...
PROC EXPORT DATA=Todo_MLN_Secciones DBMS=XLS LABEL 
		...
		SHEET='11999 Europeas'; *UTILIZAR cambiando el nombre de SHEET para añadir nueva hoja al mismo fichero Excel, p.ej. año de elecciones;
RUN;
